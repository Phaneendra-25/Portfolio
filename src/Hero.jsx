    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="text-center relative z-10 px-6">
        ...
        <motion.p
          ...
          animate="visible"
        >
          Full-Stack Developer & Digital Craftsman creating exceptional web
          experiences
        </motion.p>
          ...
          >
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <motion.button
                  onClick={() =>
                    handleExternalLink("https://github.com/Phaneendra-25")
                  }
                ...
                <motion.button
                  onClick={() =>
                    handleExternalLink("mailto:phaneendhranaidu@gmail.com")
                  }
                  className="w-full flex items-center gap-4 p-4 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 transition-all group"
                  whileHover={{ x: 5 }}
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-gray-400 text-sm">
                      phaneendhranaidu@gmail.com
                    </p>
                  </div>
                </motion.button>
                <motion.button
                  onClick={() =>
                    handleExternalLink("https://linkedin.com/in/phaneendhra-naidu-66669b36b/")
                  }
                  className="w-full flex items-center gap-4 p-4 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 transition-all group"
                  whileHover={{ x: 5 }}
                >
                ...
                <motion.button
                  onClick={() =>
                    handleExternalLink("https://instagram.com/mr.white_beard")
                  }
                  className="w-full flex items-center gap-4 p-4 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 transition-all group"
                  whileHover={{ x: 5 }}
                >
